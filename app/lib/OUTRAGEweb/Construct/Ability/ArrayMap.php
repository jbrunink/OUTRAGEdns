<?php
/**
 *	ArrayMap trait for OUTRAGEweb - maps array functions to any given
...
trait ArrayMap
{
	 ...
	 *
	 *	This should in theory, be defined in other classes as well, but this is prevented
	 *	from doing so due to a PHP bug. Probably fixed by now though...
	 */
	protected $container = [];
